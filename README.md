...
- Section reveals, curved project carousel with touch gestures, unified service card and system reduced-motion support.
...
- Four project cards, now including RizzMovies. Replace assets/rizzmovies-placeholder.svg with your screenshot path in index.html, just like the other three projects. RizzMovies has no live link yet because its public URL has not been supplied.
- One combined service card with independent checkboxes for Website Development, Landing Page Creation and SEO. Selected services appear in the same WhatsApp checkout.
- New navigation with a collapsible mobile menu and a résumé section.
- Résumé content incorporates the supplied LinkedIn PDF: SEO Teacher at Smart and Solver Software House, SEO Intern at Pasban Groups, NCBA&E Computer Science degree (2012–2016), GCU studies (2024–2025), skills and certification. Employment dates were not supplied and are omitted. The degree name follows the previously confirmed MSc Big Data Technologies. The public email remains rali314@caledonian.ac.uk as requested. A direct LinkedIn profile link is included.
- Removed rotating hero text and visible pause button. System reduced-motion preferences remain supported.

Latest checks: HTML nesting, anchors, local assets, JavaScript syntax, four-card carousel states and WhatsApp message encoding. Browser visual testing has not been performed.
